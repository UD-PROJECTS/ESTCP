...
in which :math:`\alpha` is an angle between :math:`x-` axis and beach-normal direction as shown in the figure below.

.. figure:: images/guide/nearcom/beach_direction.jpg
   :name: beach_angle
   :scale: 40 %
   :align: center
