...
.. figure:: images/guide/funwave/eta_1d_solitary.jpg
    :width: 400px
    :align: center
    :height: 500px
    :alt: alternate text
...
The following sections will be modified in "input.txt" for this case.
 ...
 Note the differences in parameter names for the solitary wave example compared to the Regular and Irregular wave examples. 